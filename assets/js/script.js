  ...
  if (
    ...
    if (signUpPassword.value == signUpCPassword.value) {
      ...
      if (SUpUserFound == 1) {
        ...
        errMsg.innerHTML =
          "User already exists. Click on the sign-in link to log in to your account";
        emptySignUpInput();
        errMsgTimeOut();
      } else {
        ...
        signUpModal.innerHTML += `Congratulations! You are now a customer of Tasty <br /> You will be redirected to the login page soon <br /> <img src='assets/img/Infinity-1s-83px.svg'>`;
...
function signInContinue() {
  ...
  if (signInEmail.value == "") {
    ...
    if (SInContinue == 1) {
      ...
      signInEmail.value = "";
      errMsg.innerHTML =
        "User does not exit, create account with the link below";
    }
  }
}
...
function signInProcess() {
  ...
  for (let index = 0; index < allUser.length; index++) {
    // Check if the email and password match for a user
    if (
      allUser[index].email == signInEmail.value &&
      allUser[index].pass == signInPassword.value
    ) {
      SInUserFound = 1;
      var i = index;
    }
...
function loadProduct() {
  ...
  if (!LSallProduct) {
    let productItem1 = new ProductItem(
      "Biore UV Aqua Rich Watery Essence Sunscreen SPF 50 (50ml)",
      "Biore UV Aqua Rich Watery Essence Sunscreen SPF 50 (50ml).jpeg",
      "₦ 3400",
      "₦ 3,500",
      "Fashion",
      true,
    ...
    let productItem2 = new ProductItem(
      ...
      "EILIFINTE B06 Casual Crossbody Shoulder Chest Bag-Grey.jpeg",
      "₦ 9000",
      "₦ 3,500",
      "Fashion",
      true,
    ...
    let productItem3 = new ProductItem(
      "Eaget Flash Drive 3.0 64GB - Metal OTG Micro USB Type-C",
      "Eaget Flash Drive 3.0 64GB - Metal OTG Micro USB Type-C.jpeg",
      "₦ 10000",
      "₦ 3,500",
      "Fashion",
      true,
    ...
    let productItem4 = new ProductItem(
      "100 Cotton Short Sleeve T-Shirts Shorts Set",
      "100 Cotton Short Sleeve T-Shirts Shorts Set.jpeg",
      "₦ 4800",
      "₦ 3,500",
      "Fashion",
      true,
    ...
    let productItem5 = new ProductItem(
      ...
      "Feng Shui Black Obsidian Wealth Bracelet.jpeg",
      "₦ 2,800",
      "₦ 3,500",
      "Fashion",
      true,
    ...
    let productItem6 = new ProductItem(
      "Fruit Lip Balm Unisex  Pink Lips Magic Cream (3Days Active)",
      "Fruit Lip Balm Unisex  Pink Lips Magic Cream (3Days Active).jpeg",
      "₦ 2,800",
      "₦ 3,500",
      "Fashion",
      true,
    ...
    let productItem7 = new ProductItem(
      "Geneva Unisex Casual Wrist Watch With Bracelet- Gold",
      "Geneva Unisex Casual Wrist Watch With Bracelet- Gold.jpeg",
      "₦ 2,800",
      "₦ 3,500",
      "Fashion",
      true,
    ...
    let productItem13 = new ProductItem(
      "Mens Sports T-shirts+Pants Suit(white)",
      "Mens Sports T-shirts+Pants Suit(white).jpeg",
      "₦ 3900",
      "₦ 3500",
      "Fashion",
      false,
    ...
    let productItem14 = new ProductItem(
      "Men's Casual Light Weight Baseball Collar Jacket-Black",
      "Men's Casual Light Weight Baseball Collar Jacket-Black.jpeg",
      "₦ 800",
      "₦ 3500",
      "Fashion",
      false,
    ...
    let productItem16 = new ProductItem(
      ...
      "IPhone X 3GB RAM+64GB(Renewed)  -Black.jpeg",
      "₦ 4800",
      "₦ 3500",
      "Fashion",
      false,
